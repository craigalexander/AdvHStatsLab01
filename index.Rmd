...
### OPTIONAL: Installing R and RStudio {#intro-installing-r}

You **DO NOT** need to intall R or RStudio on your own laptop or desktop computer.  You are expected to complete these labs on the universities PCs, and these already have R and RStudio installed.  However, R and (basic) RStudio are free to download and install, so there is a document on the Moodle page with technical details on installing R and RStudio on your computer. If you already had R and/or RStudio installed, we recommend updating to the latest version before you work through this course. 
</div>
...
- Open the “Maths-Stats” folder on your desktop.
...
Save this R Script in your M: or K: personal drive (or a USB stick that you’ve brought with you) with a relevant filename, e.g. “S1Y_Lab_1”.  **IMPORTANT: do NOT save it to the H: drive.**

Once saved in a `.R` script file, you can use your code again, so no need to type it in a second time. If you close RStudio and then open it again you can read in your code by going to
